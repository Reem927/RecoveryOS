            ...
            <div className="grid gap-4 p-5 md:grid-cols-2">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="mt-1 text-[13px] leading-relaxed text-white/65">
                    Analyze movement with the camera and AI, then auto-generate
              ...
              >
                ...
                <p className="mt-1 text-[13px] leading-relaxed text-[#6B7280]">
                  Skip the scan — manually configure the protocol and start the
                  session immediately.
                </p>
          ...
          <div className="rounded-[12px] border border-black/[0.07] bg-white">
            ...
            <ul className="divide-y divide-black/[0.05]">
              {recentClientIds.map((id) => {
                ...
                const active = selectedId === client.id && clientType === "existing"
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="truncate text-[11px] text-[#9CA3AF]">
                          {client.lastSession} · score {client.lastScore}
                        </div>
                      </div>
...
function SegButton({
  ...
  return (
    ...
    >
      <Icon
        className={`h-4 w-4 ${active ? "text-[#C97A56]" : "text-[#9CA3AF]"}`}
      />
      {label}
    </button>
  )
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <div className="mt-0.5 text-[12.5px] text-[#6B7280]">
          Nothing is persisted. Export or discard results at the end of the
          session.
        </div>
      </div>
    </div>
...
function MiniStat({
  ...
  return (
    <div className="rounded-[10px] border border-black/[0.06] bg-white p-3">
      <div className="flex items-center gap-2">
        <span
          className={`flex h-6 w-6 items-center justify-center rounded-[6px] ${toneCls}`}
        >
      ...
      <div className="mt-1.5 truncate text-[14px] font-semibold text-[#1F2937]">
        {value}
      </div>
    </div>
  )
